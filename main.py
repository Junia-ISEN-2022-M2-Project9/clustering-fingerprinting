...
parser.add_argument("--clusters", "-c", help="Number of clusters")
parser.add_argument("--threshold", "-t", help="Distance max between two fingerprints in a cluster")
...
#---------------------------------CLUSTERING-----------------------------------#
clustersData = createCluster(dataFiles, outputFileName, enableStats)
